...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      {
        img: imagesP9,
        title: 'Optimisation du référencement de sites',
    ...
    {
        img: imagesP10,
        title: 'Débogage de sites avec React Developer Tools',
  ...
  return (
        ...
        <div className='projects'>
            <div className='projects_filter'>
              <button style={{ backgroundColor: selectedYear === 'Tous' ? '#6F3F1F' : 'transparent'}} onClick={() => setSelectedYear('Tous')}>Tous</button>
              <button style={{ backgroundColor: selectedYear === '2023' ? '#6F3F1F' : 'transparent' }} onClick={() => setSelectedYear('2023')}>2023</button>
              <button style={{ backgroundColor: selectedYear === '2024' ? '#6F3F1F' : 'transparent' }} onClick={() => setSelectedYear('2024')}>2024</button>
          </div>
